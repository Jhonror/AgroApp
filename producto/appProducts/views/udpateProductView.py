...
class UdpateProductView(generics.RetrieveAPIView):
    
    def put(self, request, *args, **kwargs):
        queryset = Product.objects.all()
        serializer_class = ProductSerializer(data=request.data , intance=queryset)
    ...
    def delete(self, request, *args, **kwargs):
            queryset= Product.objects.get().delete()
